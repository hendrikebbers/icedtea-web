...
public class Launcher {
   ...
   /**
    ...
    protected  AppletInstance createApplet(JNLPFile file, boolean enableCodeBase, Container cont) throws LaunchException {
         ...
         try {
            JNLPClassLoader loader = JNLPClassLoader.getInstance(file, updatePolicy, enableCodeBase, ParserSettings.getGlobalParserSettings());
    ...
    protected ApplicationInstance createApplication(JNLPFile file) throws LaunchException {
        try {
            JNLPClassLoader loader = JNLPClassLoader.getInstance(file, updatePolicy, false, ParserSettings.getGlobalParserSettings());
            ThreadGroup group = Thread.currentThread().getThreadGroup();
