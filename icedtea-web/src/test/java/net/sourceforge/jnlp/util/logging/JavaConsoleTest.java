...
public class JavaConsoleTest {
    ...
    public void CreatePluginHeaderTestOK() throws Exception{
        ...
        Assert.assertEquals(MessageLevel.MESSAGE_DEBUG, p1.header.level);
        Assert.assertEquals(MessageLevel.WARNING_ALL, p2.header.level);
        Assert.assertEquals(MessageLevel.ERROR_ALL, p3.header.level);
    ...
    public void CreatePluginHeaderTestNotOK()throws Exception{
        ...
        Assert.assertEquals(MessageLevel.WARNING_ALL, p4.header.level);
